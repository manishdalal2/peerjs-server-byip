...
* Revamp application branding and audio handling ([90bc035](https://github.com/manishdalal2/peerjs-server-byip/commit/90bc035a79518ca82860982b17abcdf870299374))
...
* remove exclusion of UI node_modules from artifact upload ([14eb29f](https://github.com/manishdalal2/peerjs-server-byip/commit/14eb29fa7394860fb2f9002a4d2b56debcdacbf2))
...
* **deps:** update dependency @types/express to v4.17.18 ([f4bcc16](https://github.com/manishdalal2/peerjs-server-byip/commit/f4bcc1651598f349626b67099c7a39b01b417f6c))
* **deps:** update dependency @types/express to v4.17.19 ([ebec5b0](https://github.com/manishdalal2/peerjs-server-byip/commit/ebec5b07aa29e951058d64a5c98efa238ce0069a))
* **deps:** update dependency @types/express to v4.17.20 ([a6c01fd](https://github.com/manishdalal2/peerjs-server-byip/commit/a6c01fd47bfd89fa74a716650a44643612a659aa))
* **deps:** update dependency @types/express to v4.17.21 ([80df87f](https://github.com/manishdalal2/peerjs-server-byip/commit/80df87f3da63624e6c7107453f3789e76d688798))
* **deps:** update dependency @types/express to v4.17.22 ([dde901e](https://github.com/manishdalal2/peerjs-server-byip/commit/dde901e3fac8131fc29fdc3ac133b4ccb80516e0))
* **deps:** update dependency @types/express to v4.17.23 ([136cb95](https://github.com/manishdalal2/peerjs-server-byip/commit/136cb952942f10e7d2bdfc251e32c6f0e5041a89))
* **deps:** update dependency express to v4.18.3 ([ff0b83a](https://github.com/manishdalal2/peerjs-server-byip/commit/ff0b83affc3772402638dd44be521cb2d4c55417))
* **deps:** update dependency express to v4.19.0 ([208f108](https://github.com/manishdalal2/peerjs-server-byip/commit/208f1088a59b33fb6848089f1708cbcd96655a61))
* **deps:** update dependency express to v4.19.1 ([3a67b5d](https://github.com/manishdalal2/peerjs-server-byip/commit/3a67b5d30cafa1efcb33a35daebbc00766cbf1b6))
* **deps:** update dependency express to v4.19.2 ([ec993f6](https://github.com/manishdalal2/peerjs-server-byip/commit/ec993f6b7492858f61541e2ffb37110aabc6140b))
* **deps:** update dependency express to v4.20.0 ([d61c141](https://github.com/manishdalal2/peerjs-server-byip/commit/d61c141f35786dd895f0cf4df30500f8188fdcec))
* **deps:** update dependency express to v4.21.0 ([cfd95ae](https://github.com/manishdalal2/peerjs-server-byip/commit/cfd95ae7dfa3b3bb262da144d7dad01630c5ab17))
* **deps:** update dependency express to v4.21.1 ([0beb16b](https://github.com/manishdalal2/peerjs-server-byip/commit/0beb16bf28119522e73069a27b0ca6384a47c63f))
* **deps:** update dependency express to v4.21.2 ([203a2bc](https://github.com/manishdalal2/peerjs-server-byip/commit/203a2bcc49a5dc036f822b40697026db221911bb))
* **deps:** update dependency node-fetch to v3.3.1 ([2275ce3](https://github.com/manishdalal2/peerjs-server-byip/commit/2275ce35eb3c44e0a22fd4a4e0d2dca66ebd1219))
* **deps:** update dependency node-fetch to v3.3.2 ([05a1833](https://github.com/manishdalal2/peerjs-server-byip/commit/05a1833363b0592ee7941dd295c3ca9ac64d9d04))
* **deps:** update dependency ws to v8 ([1ecc94b](https://github.com/manishdalal2/peerjs-server-byip/commit/1ecc94b887d23ac59b3622a2fefc9fdab24f170f))
* **deps:** update dependency yargs to v17.7.2 ([23b4e47](https://github.com/manishdalal2/peerjs-server-byip/commit/23b4e47fb32a773d48027b0cdd0c10be7fad27cb))
* import from ESM only environments ([476299e](https://github.com/manishdalal2/peerjs-server-byip/commit/476299ed08f73e41d175d61b4281736bf8df1ea6))
* more accurate types ([68f973a](https://github.com/manishdalal2/peerjs-server-byip/commit/68f973afb44a1f71c9fd9a644602312d8ceda5cf)), closes [#182](https://github.com/manishdalal2/peerjs-server-byip/issues/182)
* **npm audit:** Updates all dependencies that cause `npm audit` to issue a warning ([1aaafbc](https://github.com/manishdalal2/peerjs-server-byip/commit/1aaafbc4504224f36287fd721f6edbc27a5b9eaa)), closes [#287](https://github.com/manishdalal2/peerjs-server-byip/issues/287)
* reduce unnecessary timeouts ([638af56](https://github.com/manishdalal2/peerjs-server-byip/commit/638af56f679881194f60b29ae7f7bb7b5756662a)), closes [#431](https://github.com/manishdalal2/peerjs-server-byip/issues/431)
* remove confusing version number ([f6314df](https://github.com/manishdalal2/peerjs-server-byip/commit/f6314df40c37add66deac5dd8487ad54e4814237))
* replace Math.random with uuid4 for a crypto secure client ID generation ([61cb151](https://github.com/manishdalal2/peerjs-server-byip/commit/61cb1517fdf9c546f944cf597966937ce26ca865))
* the server could crash if a client sends invalid frames ([29394de](https://github.com/manishdalal2/peerjs-server-byip/commit/29394dea5e1303cdf07337d39c2c93249fdd41db))


### Features

* add GITHUB_TOKEN to release workflow and enable master branch releases ([332f266](https://github.com/manishdalal2/peerjs-server-byip/commit/332f266ca72d08a09b50035755bc95e82613d831))
* add IP-based peer discovery and alias generation ([16c843a](https://github.com/manishdalal2/peerjs-server-byip/commit/16c843a1bdcdbc72e584ddf9d20a777c411fb15b))
* build Docker image for `arm64` ([#451](https://github.com/manishdalal2/peerjs-server-byip/issues/451)) ([6c37e49](https://github.com/manishdalal2/peerjs-server-byip/commit/6c37e49d66848447635988dd1187416bdeeb7683))
* drop Node {10,11,12,13} support ([b70ed79](https://github.com/manishdalal2/peerjs-server-byip/commit/b70ed79d9a239593d128ea2914eea0c2107b03b2))
* ESM support ([2b73b5c](https://github.com/manishdalal2/peerjs-server-byip/commit/2b73b5c97de4a366d6635719891b65d5f9878628))
* remove deprecated XHR fallback ([d900145](https://github.com/manishdalal2/peerjs-server-byip/commit/d90014590160faf1d489a18ea489c28c43cd4690))
* set the PEERSERVER_PATH with an environment variable ([084fb8a](https://github.com/manishdalal2/peerjs-server-byip/commit/084fb8a4bddfcb153a4cb861ba700c8352cd4b35)), closes [#213](https://github.com/manishdalal2/peerjs-server-byip/issues/213)
* set the PORT with an environment variable ([68a3398](https://github.com/manishdalal2/peerjs-server-byip/commit/68a3398f54b0f45bfe8c501c627f531980823ec1)), closes [#213](https://github.com/manishdalal2/peerjs-server-byip/issues/213)
* simplify type annotations and improve IP group handling ([428efdb](https://github.com/manishdalal2/peerjs-server-byip/commit/428efdbed658de9acc0473b1e3ee749641463077))
* specify cors options via cli or js ([05f12cd](https://github.com/manishdalal2/peerjs-server-byip/commit/05f12cdc562b1a5eb9481f5116da7c001105793a)), closes [#196](https://github.com/manishdalal2/peerjs-server-byip/issues/196) [#221](https://github.com/manishdalal2/peerjs-server-byip/issues/221)


### Performance Improvements

* use the builtin UUID generator for Peer ids instead of the `uuid` module ([5d882dd](https://github.com/manishdalal2/peerjs-server-byip/commit/5d882dd0c6af9bed8602e0507fdf5c1d284be075))
